...
## Project Structure
    ...
    ├── testbuildmodule_dev_27115  # Django project configurations
...
1. Clone this repo and `cd testbuildmodule_dev_27115`
...
2. Clone this repo and `cd testbuildmodule_dev_27115`
